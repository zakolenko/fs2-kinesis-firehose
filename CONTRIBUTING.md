# Contributing to fs2-kinesis-firehose

The fs2-kinesis-firehose project welcomes contributions from anybody wishing to participate. All code or documentation that is provided must be licensed with the same license that fs2-kinesis-firehose is licensed with (Apache 2.0, see [LICENSE](./LICENSE.md)).

## Code of Conduct

People are expected to follow the [Scala Code of Conduct](./CODE_OF_CONDUCT.md) when discussing fs2-kinesis-firehose on the Github page, Gitter channel, or other venues.
...
```
Copyright (c) $today.year the fs2-kinesis-firehose contributors.
